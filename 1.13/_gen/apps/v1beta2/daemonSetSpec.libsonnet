{
  ...
  '#withUpdateStrategy': d.fn(help='DaemonSetUpdateStrategy is a struct used to control the update strategy for a DaemonSet.', args=[d.arg(name='updateStrategy', type=d.T.any)]),
