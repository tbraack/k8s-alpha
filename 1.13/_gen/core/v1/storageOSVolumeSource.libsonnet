{
  ...
  '#withSecretRef': d.fn(help='LocalObjectReference contains enough information to let you locate the referenced object inside the same namespace.', args=[d.arg(name='secretRef', type=d.T.any)]),
