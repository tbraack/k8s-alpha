{
  ...
  '#withExternal': d.fn(help='ExternalMetricSource indicates how to scale on a metric not associated with any Kubernetes object (for example length of queue in cloud messaging service, or QPS from loadbalancer running outside of cluster). Exactly one "target" type should be set.', args=[d.arg(name='external', type=d.T.any)]),
