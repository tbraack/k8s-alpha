---
permalink: /1.13/core/v1/serviceSpec
---
...
* [`fn withSessionAffinityConfig(sessionAffinityConfig)`](#fn-withsessionaffinityconfig)
...
### fn withSessionAffinityConfig

```ts
withSessionAffinityConfig(sessionAffinityConfig)
```
